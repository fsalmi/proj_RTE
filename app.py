...
provenant des données publiques de RTE et contenant les consommations annuelles d'électricité avec un pas de 30 minutes, au niveau national. 
        ...
        children=[
            html.Div(
                ...
                children=[
                    ...
                    #html.H6("La Fabric project for RTE"),
                ],
            ),
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Img(id="logo_rte", src=app.get_asset_url("RTE_logo.svg")),
                ],
            ),
        ],
    )
